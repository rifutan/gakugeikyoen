...
var loader_desc_num = Math.floor(Math.random() * 4);
(0, _jquery2.default)('.loader__desc').html(loader_desc[loader_desc_num]);

(0, _jquery2.default)(function () {
  var h = (0, _jquery2.default)(window).height();
  (0, _jquery2.default)('.wrapper').css('display', 'none');
  (0, _jquery2.default)('.loader ,.loader__inner').height(h).css('display', 'block');
});
